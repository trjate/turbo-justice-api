...
* A user can only have a FamilyQuestion (family_question) data model associated with his ID if he indicates ***true*** on at least one of following three  attributes on the User table:
